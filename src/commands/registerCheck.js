...
export function RegisterCheck(NumDevice, TypeCheck, IsBarCode, Print) {
      ...
      // Строка с печатью фискальной строки
      {
        Register: {
          ...
          GoodCodeData: {
            ...
            BarCode:
              "0104300943734342212413195240818240640291ffd092MDEwNDMwMDk0MzczNDM",
  ...
  if (IsBarCode === false) {
    ...
    for (var i = 0; i < Data.CheckStrings.length; i++) {
      ...
      if (
        Data.CheckStrings[i] != undefined &&
        Data.CheckStrings[i].PrintImage != undefined
      ) {
  ...
  for (var i = 0; i < Data.CheckStrings.length; i++) {
    if (
      Data.CheckStrings[i] != undefined &&
      Data.CheckStrings[i].Register != undefined
    ) {
